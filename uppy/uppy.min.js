...
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function t(t,e){for(var n=0;n<e.length;n++){var i=e[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}}();require("whatwg-fetch");var _getName=function(t){return t.split("-").map(function(t){return t.charAt(0).toUpperCase()+t.slice(1)}).join(" ")};module.exports=function(){function t(e){_classCallCheck(this,t),this.opts=e,this.provider=e.provider,this.id=this.provider,this.authProvider=e.authProvider||this.provider,this.name=this.opts.name||_getName(this.id)}return _createClass(t,[{key:"checkAuth",value:function(){return fetch(this.opts.host+"/"+this.id+"/authorized",{method:"get",credentials:"include",headers:{Accept:"application/json","Content-Type":"application/json"}}).then(function(t){return t.json().then(function(t){return t.authenticated})})}},{key:"authUrl",value:function(){return this.opts.host+"/"+this.id+"/connect"}},{key:"fileUrl",value:function(t){return this.opts.host+"/"+this.id+"/get/"+t}},{key:"list",value:function(t){return fetch(this.opts.host+"/"+this.id+"/list/"+(t||""),{method:"get",credentials:"include",headers:{Accept:"application/json","Content-Type":"application/json"}}).then(function(t){return t.json()})}},{key:"logout",value:function(){var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:location.href;return fetch(this.opts.host+"/"+this.id+"/logout?redirect="+t,{method:"get",credentials:"include",headers:{Accept:"application/json","Content-Type":"application/json"}})}}]),t}();
